...
namespace Reyhan\Sum\Model\ResourceModel\Eav;
...
class Attribute extends EavAttribute implements ScopedAttributeInterface
{
     ...
     * @var string
     */
    protected $_eventPrefix = SumSetup::ENTITY_TYPE_CODE . '_entity_attribute';
    ...
    {
        $this->_init('Reyhan\Sum\Model\ResourceModel\Attribute');
    }
