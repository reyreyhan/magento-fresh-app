...
namespace Reyhan\Sum\Model\ResourceModel;

use Magento\Eav\Model\Entity\AbstractEntity;
use Magento\Eav\Model\Entity\Context;
use Magento\Store\Model\Store;
use Magento\Store\Model\StoreManagerInterface;
use Reyhan\Sum\Setup\SumSetup;

class Sum extends AbstractEntity
{
    /**
     * Store id
     *
    ...
    public function __construct(
        ...
        $this->setType(SumSetup::ENTITY_TYPE_CODE);
        $this->setConnection(SumSetup::ENTITY_TYPE_CODE . '_read', SumSetup::ENTITY_TYPE_CODE . '_write');
        $this->_storeManager = $storeManager;
    }

    /**
     * Retrieve Sum entity default attributes
     *
     * @return string[]
     */
