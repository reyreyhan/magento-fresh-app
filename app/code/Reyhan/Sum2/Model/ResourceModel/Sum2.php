...
namespace Reyhan\Sum2\Model\ResourceModel;

use Magento\Eav\Model\Entity\AbstractEntity;
use Magento\Eav\Model\Entity\Context;
use Magento\Store\Model\Store;
use Magento\Store\Model\StoreManagerInterface;
use Reyhan\Sum2\Setup\Sum2Setup;

class Sum2 extends AbstractEntity
{
    /**
     * Store id
     *
    ...
    public function __construct(
        ...
        $this->setType(Sum2Setup::ENTITY_TYPE_CODE);
        $this->setConnection(Sum2Setup::ENTITY_TYPE_CODE . '_read', Sum2Setup::ENTITY_TYPE_CODE . '_write');
        $this->_storeManager = $storeManager;
    }

    /**
     * Retrieve Sum2 entity default attributes
     *
     * @return string[]
     */
