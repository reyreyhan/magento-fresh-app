...
namespace Reyhan\Sum2\Model\ResourceModel\Eav;
...
class Attribute extends EavAttribute implements ScopedAttributeInterface
{
     ...
     * @var string
     */
    protected $_eventPrefix = Sum2Setup::ENTITY_TYPE_CODE . '_entity_attribute';
    ...
    {
        $this->_init('Reyhan\Sum2\Model\ResourceModel\Attribute');
    }
